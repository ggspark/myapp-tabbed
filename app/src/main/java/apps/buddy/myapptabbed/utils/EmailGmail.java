package apps.buddy.myapptabbed.utils;
...
public class EmailGmail extends AsyncTask<Void, Void, Void> {
     ...
     */
    public EmailGmail(String senderEmail, String senderPassword, String subject, String emailBody, String recipientEmail, EmailCallback callback) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            QLog.v("Class:" + ((Object) this).getClass().getSimpleName() + " Method:doInBackground");
    ...
    protected void onPostExecute(Void result) {
        QLog.v("Class:" + ((Object) this).getClass().getSimpleName() + " Method:onPostExecute");
